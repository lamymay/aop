...
public class ResponseVo<T> extends BaseVo {
    ...
    public ResponseVo(Integer code, String msg, Boolean success, T data) {
        this.code = code;
        this.msg = msg;
...
//        if (response == null) {
//            throw new BizRuntimeException(ErrorCode.NULL_RESPONSE);
//        }
...
//            throw new BizRuntimeException(ErrorCode.PAGE_NULL_RESPONSE);
//        }
